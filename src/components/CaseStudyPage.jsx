...
//   const projectData = caseStudyProjects[projectId] || caseStudyProjects['nk-consultancy'];
...
//         <section className="max-w-7xl mx-auto md:px-12 md:py-24 space-y-22 md:space-y-32">
//           <CaseStudyProblem problemContent={projectData.problemContent} />
//           <CaseStudySolution solutionPoints={projectData.solutionPoints} />
//           <CaseStudyImpact impactContent={projectData.impactContent} />
//         </section>
//       </main>
