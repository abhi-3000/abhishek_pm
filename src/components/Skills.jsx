...
//   const visibleSkills = group.skills.slice(0, VISIBLE_COUNT);
//   const extraSkills = group.skills.slice(VISIBLE_COUNT);
...
//                   {expanded
//                     ? 'Show less'
//                     : `+${extraSkills.length} more skill${extraSkills.length > 1 ? 's' : ''}`}
//                 </button>
//               </div>
//             </>
//           )}
